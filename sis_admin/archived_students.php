    ...
    <div class="offcanvas offcanvas-start d-md-none bg-dark text-white" tabindex="-1" id="sidebar" aria-labelledby="sidebarLabel">
        ...
        <div class="offcanvas-body">
            ...
            <ul class="nav flex-column sidebar">
                <li class="nav-item py-1"><a href="index.php" class="nav-link text-white"><i class="bi bi-house-door-fill me-1"></i> Home</a></li>
        ...
        <div class="row g-0">
            <nav class="d-none d-md-flex col-md-3 col-lg-2 bg-dark text-white flex-column p-3" style="min-height: 100vh;">
                ...
                <ul class="nav flex-column sidebar">
                    <li class="nav-item py-1"><a href="index.php" class="nav-link text-white"><i class="bi bi-house-door-fill me-1"></i> Home</a></li>
                    <li class="nav-item py-1"><a href="add_student.php" class="nav-link text-white"><i class="bi bi-plus-circle-fill me-1"></i> Add Student</a></li>
                    <li class="nav-item py-1"><a href="retrieve_student.php" class="nav-link text-white active"><i class="bi bi-person-lines-fill me-1"></i> View Students</a></li>
                    <li class="nav-item py-1"><a href="#" class="nav-link text-white"><i class="bi bi-question-circle-fill me-1"></i> FAQ</a></li>
                </ul>
            ...
            <main class="col-md-9 col-lg-10">
                <header class="d-flex justify-content-between align-items-center p-3" style="background-color: #108500;">
                    ...
                    <div class="d-flex align-items-center" style="font-size: 0.85rem;">
                        <img src="img/admin.png" alt="Admin" class="img-circle-sm img-fluid" />
                ...
                <?php
                if (isset($_GET['msg'])) {
                    echo '<div class="alert alert-warning alert-dismissible fade show m-2 px-2" role="alert">' . htmlspecialchars($_GET['msg']) . '<button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>';
                }
                if (isset($_GET['msg2'])) {
                    echo '<div class="alert alert-danger alert-dismissible fade show m-2 px-2" role="alert">' . htmlspecialchars($_GET['msg2']) . '<button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>';
                }
                ?>
                ...
                <div class="container py-3 text-white">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="retrieve_student.php" class="btn btn-primary btn-sm">Active Students</a>
                    </div>
                    <div class="table-responsive" style="max-height: 70vh;">
                        <table class="table table-bordered table-hover table-green" style="table-layout: fixed;">
                            <thead class="table-dark" style="position: sticky; top: 0; z-index: 10; background-color: #108500;">
                                <tr>
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td><a href='restore_student.php?student_id=" . htmlspecialchars($row['student_id']) . "' class='btn btn-success btn-sm p-0' onclick=\"return confirm('Restore this student?');\"><i class='bi bi-arrow-counterclockwise'></i> Restore</a></td>";
                                        echo "</tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='13' class='text-center'>No archived students found.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
